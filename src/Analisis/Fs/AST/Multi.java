            ...
            case "int":
                switch(tipo2)
                {
                    ...
                    case "double":
                        ...
                        break;
                    default:
                        //entorno.ventana.setSalida("Error de tipos operación división , linea:"+linea + "\tColumna:"+columna);
                        //(String tipo, int linea, int columna, String valor,String descripcion)
                        singlenton.addErrores(new error("semantico",linea,columna,tipo1 +" * " +tipo2,"Error de tipos en la operación multiplicación."));
                        break;
                }
                break;
            case "double":
